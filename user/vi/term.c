/* PureUNIX platform glue for Neatvi's terminal layer.
 *
 * Everything Neatvi actually draws with — term_str/term_chr/term_kill/
 * term_room/term_pos/term_window/term_rowx/term_rows/term_cols/
 ...
 *     is available, so there's nothing to poll for.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
	/* No job control on PureUNIX: ^Z is simply not actionable. */
}
